...
public class CollectionFactura {
    ...
    // Lista donde se guardan todas las facturas creadas
	...
	// Busca una factura por su número y la devuelve si la encuentra
	...
	// Muestra todas las facturas que pertenecen a un cliente según su DNI
	public static void buscarFacturasPorDni(long dni) {
		...
		boolean encontrado = false; // para saber si se encontró alguna factura
		...
		try {
			...
			if (facturas != null && !facturas.isEmpty()) {
				for (Factura fac : facturas) {
					try {
						// si la factura tiene cliente y el dni coincide, la muestra
